...
export class LoginButton extends React.Component<any, any> {
    ...
    render() {
        if (this.state.isLoggined) {
            return (<Button label="Logout" id="login_button" onClick={this.logout} />);
        } else if (!this.state.dialogVisible) {
            return (<span><Button label="Login" id="login_button" onClick={() => this.setState({ dialogVisible: true })} /></span>);
        } else {
            return (<span><Button label="Login" id="login_button" onClick={() => this.setState({ dialogVisible: true })} />
